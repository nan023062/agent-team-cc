"""
previewer.py — Local HTTP server for memory preview.

Serves static files from engine/preview/ and provides /api/entries
that reads store/short/ and store/medium/ on each request.
"""
