...
Pin a specific version: `CBIM_VERSION=1.0.3 curl ... | bash`
...
| **Status** | Available — current release `v1.0.3` | Design phase — see [`v2/`](v2/) |
...
固定版本：`CBIM_VERSION=1.0.3 curl ... | bash`
...
| **状态** | 已可用，当前发布 `v1.0.3` | 设计阶段，见 [`v2/`](v2/) |
| **安装** | 上方一行 bootstrap | — |
