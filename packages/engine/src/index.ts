...
export type { ModuleNode, Module, Snapshot } from './knowledge/index.js'
...
export type { MigrationPlan, MigrationAction, MigrationResult, MigrationActionError, MigrationSummary } from './migration/index.js'
